...
#Start app
st.write('# Amazon Review Analyzer')

st.write("##### On this page, you will find a detailed analysis of both the positive and negative features of your product, along with valuable ideas for product improvement.")

print("Loading model")
model, tokenizer, analyzer = load_model()
print("Returned from load_model()")

st.write("##### Select your brand and product for analysis.:")
...
st.write("##### Here you will get the positive and negative features of the product, and some ideas on how improve the product")
...
st.write("##### Here you will get summaries of the most voted positive and negative reviews for the product")
